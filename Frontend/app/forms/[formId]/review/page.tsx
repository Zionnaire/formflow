        ...
        <div className="bg-tertiary-fixed text-on-tertiary-fixed p-md rounded-lg mb-lg max-w-3xl w-full flex items-start gap-sm shadow-card border border-tertiary-fixed-dim/20">
          ...
          <div>
            ...
            <p className="font-body-md text-body-md text-on-tertiary-fixed-variant">
              You&apos;ve missed a few non-required fields. You can still download, but we recommend filling them for
              a complete application.
            </p>
          </div>
          <Link href={`/forms/${formId}/editor`} className="ml-auto font-label-sm text-label-sm text-tertiary underline hover:text-on-tertiary-fixed transition-colors shrink-0">
            Review fields
          </Link>
        </div>
